...
public class MedicineDel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(system.getUserAccountDirectory().checkIfUsernameIsUnique(jTextField4.getText())){
            ...
            MedicineDelivery customer = new MedicineDelivery(jTextField1.getText(),jTextField4.getText(), jTextField5.getText(),  jTextField3.getText(),jTextField2.getText() );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(int i=0;i<z;i++)
        {
                ...
                if(!jTextField3.getText().matches("[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"))
            {
                ...
                c.setUserLocation(jTextField2.getText());
                c.setPhNumber(jTextField3.getText());
