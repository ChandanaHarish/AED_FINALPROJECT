 ...
 * @author ajay09
 */
public class Deliverymanframe extends javax.swing.JPanel {

    private JPanel container;

    /**
     * Creates new form deliverymanframe
     */
    ...
    public Deliverymanframe(JPanel container,EcoSystem system) {
        initComponents();
    ...
    private void populateTable() {
        DeliveryManDirectory deliveryman = system.getDeliveryManDirectory();
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();

        model.setRowCount(0);
        for (DeliveryMan customer : deliveryman.getDeliveryManList()) {
