...
public class vaccine extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        MentalHealthDirectory  red=ecosystem.getMhd();
        ArrayList<MentalHealth> ol=red.getarray();
        int u=ol.size();
        for(int i=0;i<u;i++)
        {
        ...
        for(int i=0;i<u;i++)
        {
            ...
            if((o.getPharmacy().matches(ph1.getName()) && (o.getStatus().matches("Approved")||o.getStatus().matches("Done")))==true)
            {
                ...
                String s[]={s1,o.getFirstName(),o.getStatus(),o.getConsultant(),o.getDate(),o.getTime()};
                t2.addRow(s);
            }
