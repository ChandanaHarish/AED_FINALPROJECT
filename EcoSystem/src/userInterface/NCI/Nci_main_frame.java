 ...
 * @author raksh
 */
public class Nci_main_frame extends javax.swing.JPanel {
     ...
     */
    public Nci_main_frame(JPanel container,EcoSystem system,UserAccount userAccount) {
        initComponents();
        this.container=container;
        this.ecosystem=system;
        this.userAccount=userAccount;
        NCI g=(NCI)userAccount;
        jLabel7.setText("Welcome "+g.getFirstName());
    }
    ...
    private void initComponents() {
        ...
        container1.setBackground(new java.awt.Color(185, 219, 168));
        ...
        jLabel5.setText("Cancer Death Rate");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(145, 145, 145)))
                .addComponent(container1, javax.swing.GroupLayout.PREFERRED_SIZE, 828, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//        backAction();
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        ArrayList<GeneralVitals> c1=c.getArray();
        int a=0;
        int b=0;
        for(int i=0;i<c1.size();i++)
        {
            
            GeneralVitals c2 = c1.get(i);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        // TODO add your handling code here:
        userDirectory v =ecosystem.getUserDirectory();
       ...
       int a1=0;
        ArrayList<MentalHealth> vr=vrd.getarray();
        for(int i=0;i<vr.size();i++ )
        {
            MentalHealth vr1=vr.get(i);
