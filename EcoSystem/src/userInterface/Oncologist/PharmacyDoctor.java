...
public class PharmacyDoctor extends javax.swing.JPanel {
     ...
     */
    public PharmacyDoctor(JPanel container,EcoSystem system,UserAccount userAccount,String userid) {
        initComponents();
           initComponents();
        ...
        PharmacyDirectory rd=system.getPharmacyDirectory();
        ArrayList<Pharmacy> list=rd.getPh();        
        int s=list.size();
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(jScrollPane3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 590, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(t.getRowCount()!=0)
        {
            OrderMedicine m=new OrderMedicine();
            int x = 1 + (int) (Math.random() * 100);
            m.setID(x);
            m.setPatientID(patientid);
            Oncologist u=(Oncologist)(userAccount);
            m.setOncologistName(u.getFirstname());
            m.setPharmacyName(jComboBox1.getSelectedItem().toString());
            m.setOrderStatus("Order Placed");

            Map<String,String> f=m.getListOfOrders();
            Map<String,String> f1=m.getListOfCost();
            int a=t.getRowCount();
            for(int i=0;i<a;i++)
            {
            ...
            OrderRequestDirectory dire=system.getOrderRequestDirectory();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        for(int i=0;i<j;i++)
        {
            ...
            if(s.matches(r.getName()))
            {
                ...
                Map<String,String> abc=r.getGeneralMedicines();
