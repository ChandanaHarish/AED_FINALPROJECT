 ...
 * @author raksh
 */
public class therapy extends javax.swing.JPanel {
     ...
     */
    public therapy(JPanel container,EcoSystem ecosystem,UserAccount userAccount) {
        initComponents();
        this.container=container;
        this.ecosystem=ecosystem;
        this.userAccount=userAccount;
        ConsultancyPage v=(ConsultancyPage)userAccount;
        jLabel5.setText(v.getCity());
    }
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
       ...
       ConsultancyPage v1=(ConsultancyPage)userAccount;
       ...
       int b =0;
        ...
        for(int i=0;i<vr.size();i++ )
        {
            ...
            if(vr1.getStatus().matches("Done"))
            {
                ...
                if(vr1.getConsultant().matches(v1.getCity()))
                {
                    b+=1;
                }
