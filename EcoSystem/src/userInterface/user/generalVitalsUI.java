 ...
 * @author css19
 */
public class generalVitalsUI extends javax.swing.JPanel {
private final JPanel container;
     ...
     */
    public generalVitalsUI(JPanel container,EcoSystem ecosystem,UserAccount userAccount) {
        initComponents();
        ...
        jtof.setText(a.getEmailID());
        
    
       
        CancerHospitalsDirectory cd=ecosystem.getChd();
        ArrayList<CancerHospitals> ol=cd.getA();
        int u=ol.size();
        for(int i=0;i<u;i++)
        {
            CancerHospitals o=ol.get(i);
            jComboBox2.addItem(o.getHospitalName());
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Have you taken the flu shot ?");

        jLabel8.setFont(new java.awt.Font("Berlin Sans FB", 0, 12)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Have you been diagonised with flu or any other disease in the past 6 months ?");
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel1, jLabel2, jLabel4, jLabel5, jLabel9});
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jComboBox3, jComboBox4, jComboBox5, jLabel3, jLabel7, jLabel8});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel2, jLabel4, jLabel5, jLabel9});
...
private void backAction() {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(selectedRow>=0)
        {
            ...
            GeneralVitalsDirectory cdd =ecosystem.getGvd();
            ArrayList<GeneralVitals> ol=cdd.getArray();
            int u=ol.size();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(selectedRow>=0)
        {
            ...
            {
                GeneralVitals o=ol.get(i);
                if(s==o.getPatientID()/*&&o.getStatus().matches("Deliver Man Assigned")*/)
                {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            GeneralVitals c1 =new GeneralVitals();
            int x = 1 + (int) (Math.random() * 100);
            c1.setPatientID(x);
            c1.setFirstName(jTextField1.getText());
            c1.setCancerHospitals(jComboBox2.getSelectedItem().toString());
            c1.setTemperature(jTextField2.getText());
            c1.setContactCovid(jComboBox3.getSelectedItem().toString());
            ...
            c1.setBookAppointment(d1);
            c1.setAppointmentTime(jComboBox1.getSelectedItem().toString());
...
public void populate_table()
    {
        ...
        for(int i=0;i<u;i++)
        {
            ...
            if(userAccount.getUsername().matches(o.getUserID()))
            {
                ...
                String s[]={s1,o.getStatus(),o.getCancerHospitals(),o.getTemperature(), o.getBookAppointment(),o.getAppointmentTime(),o.getResult()};
                t2.addRow(s);
            }
        }
